...
{
    public partial class frmHoatDongHNXHDoiTuongKhac : Form
    {

        public frmHoatDongHNXHDoiTuongKhac()
        {
            InitializeComponent();
        }
        ...
        public BindingList<QL_HOATDONG_HNXH_DOITUONG_KHAC> data;
        private Int64 idRowSelected;

        private void frmHoatDongHNXHDoiTuongKhac_Load(object sender, EventArgs e)
        {
