...
{
    public partial class frmHoatDongASXHDoiTuongKhac : Form
    {

        public frmHoatDongASXHDoiTuongKhac()
        {
            InitializeComponent();
        }
        ...
        public BindingList<QL_HOATDONG_ASXH_DOITUONG_KHAC> data;
        private Int64 idRowSelected;

        private void frmHoatDongASXHDoiTuongKhac_Load(object sender, EventArgs e)
        {
        ...
        {
            _clearData();
            QL_HOATDONG_ASXH_DOITUONG_KHAC item = gvGrid.GetFocusedRow() as QL_HOATDONG_ASXH_DOITUONG_KHAC;
            if (item != null)
            {
        ...
        private void _setObjectEntities(ref QL_HOATDONG_ASXH_DOITUONG_KHAC item)
        {
        ...
        private void _saveData()
        {
            if (_validateControl())
            {
                ...
                {
                    QL_HOATDONG_ASXH_DOITUONG_KHAC item;
                    switch (_formStatus)
                    {
                        case EnumFormStatus.ADD:

                            item = new QL_HOATDONG_ASXH_DOITUONG_KHAC();
