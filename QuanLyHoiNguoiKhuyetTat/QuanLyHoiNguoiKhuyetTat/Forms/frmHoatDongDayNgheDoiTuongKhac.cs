...
{
    public partial class frmHoatDongDayNgheDoiTuongKhac : Form
    {

        public frmHoatDongDayNgheDoiTuongKhac()
        {
            InitializeComponent();
        }
        ...
        public BindingList<QL_HOATDONG_DAYNGHE_DOITUONG_KHAC> data;
        ...
        {
            _clearData();
            QL_HOATDONG_DAYNGHE_DOITUONG_KHAC item = gvGrid.GetFocusedRow() as QL_HOATDONG_DAYNGHE_DOITUONG_KHAC;
            if (item != null)
            {
        ...
        private void _setObjectEntities(ref QL_HOATDONG_DAYNGHE_DOITUONG_KHAC item)
        {
