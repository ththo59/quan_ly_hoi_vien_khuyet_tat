...
{
    public partial class frmHoatDongHoiChoTrienLamDoiTuongKhac : Form
    {

        public frmHoatDongHoiChoTrienLamDoiTuongKhac()
        {
            InitializeComponent();
        }
        ...
        public BindingList<QL_HOATDONG_HOICHO_TRIENLAM_DOITUONG_KHAC> data;
        private Int64 idRowSelected;

        private void frmHoatDongHoiChoTrienLamDoiTuongKhac_Load(object sender, EventArgs e)
        {
        ...
        {
            _clearData();
            QL_HOATDONG_HOICHO_TRIENLAM_DOITUONG_KHAC item = gvGrid.GetFocusedRow() as QL_HOATDONG_HOICHO_TRIENLAM_DOITUONG_KHAC;
            if (item != null)
            {
        ...
        private void _setObjectEntities(ref QL_HOATDONG_HOICHO_TRIENLAM_DOITUONG_KHAC item)
        {
        ...
        private void _saveData()
        {
            if (_validateControl())
            {
                ...
                {
                    QL_HOATDONG_HOICHO_TRIENLAM_DOITUONG_KHAC item;
                    switch (_formStatus)
                    {
                        case EnumFormStatus.ADD:

                            item = new QL_HOATDONG_HOICHO_TRIENLAM_DOITUONG_KHAC();
