...
{
    public partial class frmDoiTuongKhac : Form
    {

        public frmDoiTuongKhac()
        {
            InitializeComponent();
        }
        ...
        public BindingList<QL_HOATDONG_DOITUONG_KHAC> data;
        private Int64 idRowSelected;
        private Int64 _loaiHoatDongId;

        private void frmDoiTuongKhac_Load(object sender, EventArgs e)
        {
        ...
        {
            _clearData();
            QL_HOATDONG_DOITUONG_KHAC item = gvGrid.GetFocusedRow() as QL_HOATDONG_DOITUONG_KHAC;
            if (item != null)
            {
        ...
        private void _setObjectEntities(ref QL_HOATDONG_DOITUONG_KHAC item)
        {
            item.LOAI_HD_ID = _loaiHoatDongId;
        ...
        private void _saveData()
        {
            if (_validateControl())
            {
                ...
                {
                    QL_HOATDONG_DOITUONG_KHAC item;
                    switch (_formStatus)
                    {
                        case EnumFormStatus.ADD:

                            item = new QL_HOATDONG_DOITUONG_KHAC();
