...
{
    public partial class ucBCHoiVienTongNKTCoViecLam : ucBase
    {
        XtraReport rptGlobal = new XtraReport();
        public ucBCHoiVienTongNKTCoViecLam()
        {
            InitializeComponent();
        }

        private void ucBCHoiVienTongNKTCoViecLam_Load(object sender, EventArgs e)
        {
        ...
        private void _loadData()
        {
            ...
            rptBCHoiVien_NKTCoViecLam rpt = new rptBCHoiVien_NKTCoViecLam();
