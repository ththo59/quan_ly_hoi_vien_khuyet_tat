...
{
    public partial class ucBCHoiVienTongNKTThamGiaHoatDong : ucBase
    {
        XtraReport rptGlobal = new XtraReport();
        public ucBCHoiVienTongNKTThamGiaHoatDong()
        {
            InitializeComponent();
        }
        ...
        private void _loadData()
        {
            ...
            rptBCHoiVien_NKTThamGiaHoatDong rpt = new rptBCHoiVien_NKTThamGiaHoatDong();
