...
{
    public partial class ucHoatDongTimKiem : DevExpress.XtraEditors.XtraUserControl
    {
        public ucHoatDongTimKiem()
        {
            InitializeComponent();
        }

        private void ucHoatDongTimKiem_Load(object sender, EventArgs e)
        {
            //CommandData();
