...
{
    public partial class ucPhieuThuChi : DevExpress.XtraEditors.XtraUserControl
    {
        Boolean _laPhieuChi = false;
        public ucPhieuThuChi(Boolean laPhieuChi = false)
        {
            InitializeComponent();
            _laPhieuChi = laPhieuChi;
        }

        private void ucPhieuThuChi_Load(object sender, EventArgs e)
        {
            //CommandData();
            FormStatus = EnumFormStatus.VIEW;
            if (_laPhieuChi)
            {
                grpDanhSach.Text = "Danh sách phiếu chi tháng 12/2017";
                layoutNgay.Text = "Ngày chi";
                txtNoiDung.Text = "Chi tiền điện, nước, internet quý 1/2017 ";
            }
        }
