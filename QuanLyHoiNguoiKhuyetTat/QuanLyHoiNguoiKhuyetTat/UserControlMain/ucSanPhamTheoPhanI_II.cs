...
{
    public partial class ucSanPhamTheoPhanI_II : DevExpress.XtraEditors.XtraUserControl
    {
        public ucSanPhamTheoPhanI_II()
        {
            InitializeComponent();
        }

        private void ucSanPhamTheoPhanI_II_Load(object sender, EventArgs e)
        {
            cboGoiThau.Properties.DataSource = FunctionHelper.LoadGoiThau();
            lueCongTy.Properties.DataSource = FunctionHelper.LoadCongTy();
            cboGoiThau.EditValue = "25, 26, 27, 28, 29, 30, 44";
        ...
        private void btnControl_btnEventView_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("LocSanPhamTheoPhanI_II", clsConnection._conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@CTY_MA", SqlDbType.NVarChar).Value = lueCongTy.EditValue +string.Empty;
            cmd.Parameters.Add("@GOITHAU_ID", SqlDbType.NVarChar).Value = (cboGoiThau.EditValue +string.Empty).Trim();
            cmd.Parameters.Add("@DIEMPHANI", SqlDbType.Int).Value = seDiemI.EditValue;
            cmd.Parameters.Add("@DIEMPHANII", SqlDbType.Int).Value = seDiemII.EditValue;
            cmd.CommandTimeout = 0;
            SqlDataAdapter da = new SqlDataAdapter();
            da.SelectCommand = cmd;
            da.Fill(ds, "LocSanPhamTheoPhanI_II");
            gcGrid.DataSource = ds.Tables["LocSanPhamTheoPhanI_II"];
        }
        ...
        private void btnControl_btnEventExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                excelManager
                    ...
                    .SetRangeValue("DANH MỤC SẢN PHẨM ĐẠT ĐIỂM PHÂN I, II CỦA CÔNG TY : " + (lueCongTy.EditValue +string.Empty));
