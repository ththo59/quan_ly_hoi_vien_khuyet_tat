...
{
    public partial class ucBCHoiVienTongNKTPhuNuCoGiaDinh : ucBase
    {
        XtraReport rptGlobal = new XtraReport();
        public ucBCHoiVienTongNKTPhuNuCoGiaDinh()
        {
            InitializeComponent();
        }
        ...
        private void _loadData()
        {
            ...
            var data = (from p in context.QL_HOIVIEN
                        ...
                        && p.HV_GIOI_TINH == "Nữ"
                        && p.HV_TINHTRANG_HONNHAN == "Đã lập gia đình"
                        select p).ToList();

            rptBCHoiVien_NKTPhuNuCoGiaDinh rpt = new rptBCHoiVien_NKTPhuNuCoGiaDinh();
