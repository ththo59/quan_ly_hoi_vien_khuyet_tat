...
{
    public partial class ucPhieuThuChiTimKiem : DevExpress.XtraEditors.XtraUserControl
    {
        public ucPhieuThuChiTimKiem()
        {
            InitializeComponent();
        }

        private void ucPhieuThuChiTimKiem_Load(object sender, EventArgs e)
        {
            //CommandData();
