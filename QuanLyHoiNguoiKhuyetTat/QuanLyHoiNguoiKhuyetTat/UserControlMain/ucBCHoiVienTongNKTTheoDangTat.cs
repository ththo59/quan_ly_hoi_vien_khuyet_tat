...
{
    public partial class ucBCHoiVienTongNKTTheoDangTat : ucBase
    {
        XtraReport rptGlobal = new XtraReport();
        public ucBCHoiVienTongNKTTheoDangTat()
        {
            InitializeComponent();
        }

        private void ucBCHoiVienTongNKTTheoDangTat_Load(object sender, EventArgs e)
        {
        ...
        private void _loadData()
        {
            ...
            rptBCHoiVien_NKTTheoDangTat rpt = new rptBCHoiVien_NKTTheoDangTat();
