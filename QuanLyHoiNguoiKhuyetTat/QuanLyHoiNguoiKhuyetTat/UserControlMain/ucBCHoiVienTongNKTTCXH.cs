...
{
    public partial class ucBCHoiVienTongNKTTCXH : ucBase
    {
        XtraReport rptGlobal = new XtraReport();
        public ucBCHoiVienTongNKTTCXH()
        {
            InitializeComponent();
        }

        private void ucBCHoiVienTongNKTTCXH_Load(object sender, EventArgs e)
        {
